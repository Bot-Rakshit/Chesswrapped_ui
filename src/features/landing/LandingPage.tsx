...
const LandingPage: FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-[#0a1628] flex flex-col">
      ...
      {/* Main Content Area - Stops above dock */}
      <main className="flex-1 overflow-hidden relative z-40">
        <div className="h-[calc(100vh-88px)] md:h-full overflow-y-auto">
          <div className="min-h-full flex items-center justify-center px-3 xs:px-4 sm:px-6">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut" }}
              className="w-full max-w-2xl mx-auto py-6 xs:py-8 sm:py-12 md:py-16"
            >
      ...
      {/* Dock Area - Fixed Height */}
      <div className="h-[88px] md:h-0 shrink-0 relative z-50">
